...
func NewReturnableTaskPool[T, R comparable](concurrent int, createInterval time.Duration, taskList []T, runFunction func(task T, taskPool *ReturnableTaskPool[T, R]) R, shutdownFunction func(taskPool *ReturnableTaskPool[T, R])) *ReturnableTaskPool[T, R] {
